...
SECRET_KEY = 'django-insecure-w(7wj(@n63xg)w=@0w^zv=oqclp=1%wuj76kr0m+4%u_0p5%8u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["internship-form-project.herokuapp.com"]
...
EMAIL_HOST_USER = 'hospitalamanage@gmail.com'
